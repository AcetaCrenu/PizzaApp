...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int photo = intent.getIntExtra("photo", 1); // Supposons que "photo" est de type int pour la ressource d'image
        ...
        ImageView pizzaImageView = findViewById(R.id.img); // Assurez-vous que l'ID de l'ImageView correspond à celui dans votre mise en page XML
